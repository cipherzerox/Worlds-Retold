...
public class RenderSentinel extends RenderLiving<EntitySentinel> {
    ...
    private ResourceLocation TEXTURE = new ResourceLocation("hailstorm:textures/entity/sentinel.png");
    private ResourceLocation DYING_TEXTURE = new ResourceLocation("hailstorm:textures/entity/sentinel_dying.png");
