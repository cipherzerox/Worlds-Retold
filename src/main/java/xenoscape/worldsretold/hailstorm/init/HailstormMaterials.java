...
public class HailstormMaterials {
	...
	public static void initRepairMaterials() {
		...
		HailstormMaterials.CRYONITE_ARMOR.setRepairItem(new ItemStack(HailstormItems.CRYONITE));

		HailstormMaterials.CRYONITE_TOOL.setRepairItem(new ItemStack(HailstormItems.CRYONITE));
		HailstormMaterials.UNIQUE_TOOL.setRepairItem(new ItemStack(HailstormItems.CRYONITE));
	}
