package xenoscape.worldsretold.hailstorm.entity.projectiles.scroll;
...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("worldsretold:textures/entity/projectile/blizzscroll.png");
