...
import xenoscape.worldsretold.hailstorm.entity.projectiles.ModelSphere;

public class RenderHail extends Render<EntityHail>
{
    private ResourceLocation TEXTURE = new ResourceLocation("worldsretold:textures/entity/snow_roller.png");
