package xenoscape.worldsretold.hailstorm.entity.neutral.sentinel;
...
public class RenderSentinel extends RenderLiving<EntitySentinel> {
    ...
    public static final xenoscape.worldsretold.hailstorm.entity.neutral.sentinel.RenderSentinel.Factory FACTORY = new xenoscape.worldsretold.hailstorm.entity.neutral.sentinel.RenderSentinel.Factory();
    ...
    public static class Factory implements IRenderFactory<EntitySentinel> {
        ...
        public Render<? super EntitySentinel> createRenderFor(RenderManager manager) {
            return new xenoscape.worldsretold.hailstorm.entity.neutral.sentinel.RenderSentinel(manager);
        }
    }
}
