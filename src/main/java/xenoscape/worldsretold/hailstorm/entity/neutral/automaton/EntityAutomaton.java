...
public class EntityAutomaton extends EntitySurfaceMonster {
	...
	protected void dropFewItems(boolean wasRecentlyHit, int lootingModifier) {
		if (wasRecentlyHit && this.rand.nextInt(12) == 0) {
			EntityItem entityitem = this.dropItem(HailstormItems.RELIC_SWORD, 1);
			if (entityitem != null) {
	...
	public void setEquipmentBasedOnDifficulty(DifficultyInstance difficulty) {
		...
		this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(HailstormItems.RELIC_SWORD));
	}
