...
public class LayerGuardsmanDeath implements LayerRenderer<EntityGuardsman>
{
    public void doRenderLayer(EntityGuardsman entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
